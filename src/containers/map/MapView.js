...
import { faTimesCircle, faCreditCard, faGlobe } from "@fortawesome/free-solid-svg-icons";
import {
...
const MapView = () => {
  ...
  function renderIcon(motive) {
    if (motive != null) {
      return <FontAwesomeIcon icon={ faCreditCard } style={ { marginRight: 5 } } color={ "#C2185B" } size="lg"/>
    }
    return <FontAwesomeIcon icon={ faGlobe } style={ { marginRight: 5 } } color={ "#4CAF50" } size="lg"/>
  }
